...
app = FastAPI(title="COTA 10 Football Analyzer", version="1.1")
...
@app.get("/health")
def health():
    return {"status": "ok", "api_key_configured": bool(API_KEY), "version": "1.1"}
