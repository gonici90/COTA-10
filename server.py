...
def home_extended():
    ...
    extra = marker + '<br><button onclick="ticketBt(1.5)">90 zile · COTA 1.50</button><button onclick="ticketBt(2)">90 zile · COTA 2</button><button onclick="ticketBt(5)">90 zile · COTA 5</button><button onclick="ticketBt(10)">90 zile · COTA 10</button>'
